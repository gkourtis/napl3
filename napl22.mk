...
LinkOptions            :=  -mx32 -pthread 
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)/usr/include/x86_64-linux-gnu/c++/5/x32 $(IncludeSwitch)/usr/include/x86_64-linux-gnu $(IncludeSwitch)/usr/include 
IncludePCH             := 
RcIncludePath          := 
...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS :=  -O0 -mx32 -std=c++14 -g -funsigned-char -fpermissive -Wno-logical-op-parentheses -pthread  $(Preprocessors)
