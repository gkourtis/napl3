...
public:
uWord sizeofHeader() const; // the header contains various size and type data
uWord sizeofData() const;		// The data part contains the data of the object
uWord sizeofBody() const;		// the body is header + data part.
